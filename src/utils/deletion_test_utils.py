...
def plot_heatmap(
    img_idx, heatmap, concept, heatmap_type="change_sim", dataset_name="CLEVR", save_file=None
):
    """
    ...
    heatmap_overlay = plt.imshow(
        heatmap,
        cmap="hot",
        alpha=0.5,
        extent=[0, grayscale_image.size[0], grayscale_image.size[1], 0],
    )
...
def plot_heatmaps_all_concepts(
    img_idx, heatmaps, heatmap_type="change_sim", dataset_name="CLEVR", save_file=None
):
    """
